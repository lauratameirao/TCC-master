...
O modelo foi desenvolvido com elementos do tipo casca (PSHELL) para o reforçador e para o revestimento, e com duas propriedades distintas, sendo uma propriedade para o revestimento e outra propriedade para o reforçador.

O painel reforçado foi modelado utilizando somente um reforçador e para isso as seguintes condições de contorno foram aplicadas, conforme mostrado na (adicionar figura). %\autoref{fig_StiffMetalConst}.
...
utilizando um elemento rígido do tipo RBE2 para distribuir a carga nos elementos de placa.
